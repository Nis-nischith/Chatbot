CREATE DATABASE  IF NOT EXISTS `ruchi_eateries` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ruchi_eateries`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: ruchi_eateries
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'ruchi_eateries'
--
